...
pizza7 = Pizza.create(restaurant_name: "mellow mushroom", menu_name: "kosmic karma", pizza_category: "stone baked", pizza_ingredients: "mellow red sauce base with feta cheese, mozzarella, spinach, sun-dried roasted tomatoes, roma tomatoes, finished with a pesto swirl")
